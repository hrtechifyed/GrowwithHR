 ...
 * Learning Intelligence Validator
 * -----------------------------------------------------------------------------
 * File      : js/modules/learning/validator.js
 * Version   : 1.0.0
 * =============================================================================
 */
...
class LearningValidator {
    ...
    validateOrganization(company, errors) {
        ...
        if (
            ...
            errors.push(
                "Managers are required to support learning and development."
            );
...
const learningValidator =
    new LearningValidator();

export { LearningValidator };

export default learningValidator;

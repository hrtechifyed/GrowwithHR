 ...
 * Leadership Intelligence Validator
 * -----------------------------------------------------------------------------
 * File      : js/modules/leadership/validator.js
 * Version   : 1.0.0
 * =============================================================================
 */
...
class LeadershipValidator {
    ...
    validateOrganization(company, errors) {
        ...
        if (
            ...
            errors.push(
                "Leadership hierarchy is required."
            );
...
export { LeadershipValidator };

export default leadershipValidator;

 ...
 * Culture Intelligence Validator
 * -----------------------------------------------------------------------------
 * File      : js/modules/culture/validator.js
 * Version   : 1.0.0
 * =============================================================================
 */
...
class CultureValidator {
    ...
    validateOrganization(company, errors) {
        ...
        if (
            ...
            errors.push(
                "Leadership structure is recommended for culture initiatives."
            );
...
const cultureValidator =
    new CultureValidator();

export { CultureValidator };
